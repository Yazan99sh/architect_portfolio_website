...
class TabletAbout extends StatefulWidget {
  ...
  TabletAbout(this.index,this.screenType);

  @override
  _TabletAboutState createState() => _TabletAboutState();
}

class _TabletAboutState extends State<TabletAbout> with TickerProviderStateMixin{
    ...
    WidgetsBinding.instance.addPostFrameCallback((_){
      ...
      if (widget.index!=-1) {
        _controller.animateTo(
            800, duration: Duration(milliseconds: 1000), curve: Curves.easeIn);
      }
    });
  }
  @override
