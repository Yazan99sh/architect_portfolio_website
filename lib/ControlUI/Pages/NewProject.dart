...
import 'package:shaher_website/Services/NewProject.dart';
...
class _NewProjectState extends State<NewProject> {
          ...
          child: Center(
            child:loading?Container(
              ...
              children: [
                ...
                ContactMeField(width: 500,hintText:'Project Title',controller:title,error: tit,),
                Container(height: 16,),
                ContactMeField(width: 500,hintText:'Project Extra Info...',maxLine: 6,controller: info,error: inf,),
                Container(height: 16,),
                Container(height: 16,),
                Container(
                  ...
                  child:Center(
                    child:Column(
                      ...
                      children: [
                        ...
                        Container(height: 16,),
                        Text('Select Project Poster',style: TextStyle(
                          fontFamily:
                          ArabicFonts.Cairo,
                          package:
                          'google_fonts_arabic',
  ...
  Future check(PlatformFile file, String title , String info)async{
    ...
    if (!tit && !inf && handled){
      bool suc = await newProject(title,info,file);
      if (suc){
        setState(() {
          loading = false;
        });
